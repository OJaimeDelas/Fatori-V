#ifndef H_IOB_SYSTEM_TESTER_IOB_CYCLONEV_GT_DK_CONF_H
#define H_IOB_SYSTEM_TESTER_IOB_CYCLONEV_GT_DK_CONF_H
...
#define IOB_SYSTEM_TESTER_IOB_CYCLONEV_GT_DK_VERSION 0x0081

#endif // H_IOB_SYSTEM_TESTER_IOB_CYCLONEV_GT_DK_CONF_H
