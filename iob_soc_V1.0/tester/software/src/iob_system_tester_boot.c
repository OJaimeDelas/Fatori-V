...
#ifdef IOB_SYSTEM_TESTER_USE_EXTMEM
  uart_puts(PROGNAME);
  uart_puts(": DDR in use.\n");
#endif

  // address to copy firmware to
  char *prog_start_addr = (char *)IOB_SYSTEM_TESTER_FW_BASEADDR;
...
#ifndef IOB_SYSTEM_TESTER_INIT_MEM
  // receive firmware from host
  int file_size = 0;
  char r_fw[] = "iob_system_tester_firmware.bin";
