#ifndef H_IOB_SYSTEM_TESTER_MWRAP_CONF_H
#define H_IOB_SYSTEM_TESTER_MWRAP_CONF_H
...
#define IOB_SYSTEM_TESTER_MWRAP_VERSION 0x0081

#endif // H_IOB_SYSTEM_TESTER_MWRAP_CONF_H
