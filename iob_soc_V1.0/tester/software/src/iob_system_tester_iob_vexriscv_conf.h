#ifndef H_IOB_SYSTEM_TESTER_IOB_VEXRISCV_CONF_H
#define H_IOB_SYSTEM_TESTER_IOB_VEXRISCV_CONF_H
...
#define IOB_SYSTEM_TESTER_IOB_VEXRISCV_VERSION 0x0001

#endif // H_IOB_SYSTEM_TESTER_IOB_VEXRISCV_CONF_H
