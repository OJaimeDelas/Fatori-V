...
RUN_DEPS+=iob_system_tester_bootrom.hex iob_system_tester_firmware.hex
...
BUILD_DEPS+=iob_system_tester_bootrom.hex $(if $(filter $(INIT_MEM),1),iob_system_tester_firmware.hex)

QUARTUS_SEED ?=5
SDC_PREFIX=iob_system_tester
